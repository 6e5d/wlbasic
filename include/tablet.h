#ifndef INCLUDEGUARD_WLBASIC_TABLETH
#define INCLUDEGUARD_WLBASIC_TABLETH
...
void tablet_id(void *data, struct zwp_tablet_v2 *zwp_tablet_v2, uint32_t vid, uint32_t pid);
void tablet_path(void *data, struct zwp_tablet_v2 *zwp_tablet_v2, const char *path);
...
void tabtool_down(void *data, struct zwp_tablet_tool_v2* tool, uint32_t serial);
...
void tabtool_tilt(void *data,
struct zwp_tablet_tool_v2* tool,
wl_fixed_t tilt_x, wl_fixed_t tilt_y);
void tabtool_rotation(void *data, struct zwp_tablet_tool_v2* tool, wl_fixed_t degrees);
